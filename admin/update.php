...
<body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p>يمكنك تعديل الاهداء عند الخطأ</p>
   ...
   <script>
                ...
                CKEDITOR.replace( 'address' );
                        ...
                        <input type="submit" class="btn btn-primary btn-block" value="تعديل">
